...
function Hero() {
   return (
      <div className='pb-20 pt-36 text-white'>
         ...
         <div className="h-screen w-full dark:bg-black-100 bg-white dark:bg-grid-white/[0.05] bg-grid-black/[0.2] flex items-center justify-center absolute left-0">
         ...
         <div className="relative flex justify-center my-20 z-10">
            <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col justify-center items-center">
               ...
               <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl">
                  Hello, I&apos;m Ashraf, a full-stack developer with over 10 years of experience creating functional Web-Applications.
               </p>
               <a href="#about">
